...
@Listeners(Firstpackage.ListenerClass.class)
public class Firstclass {
	...
	public void Openbrowser() throws IOException
	{
		...
		Firstclass.driver = new ChromeDriver();
	...
	{
		Firstclass.driver.manage().window().maximize();
	...
	public void password() throws IOException
	{
		...
		Firstclass.driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		WebElement username = Firstclass.driver.findElement(By.xpath("//input[@type='text']"));
		username.click();
		System.out.println("username field clicked");
		username.sendKeys("a.pandian@wintlt.com");
		System.out.println("Username field entered");
		WebElement password = Firstclass.driver.findElement(By.xpath("//input[@type='password']"));
		password.click();
		System.out.println("password field clicked");
		password.sendKeys("12345S#");
		System.out.println("password field entered");
		WebElement button = Firstclass.driver.findElement(By.xpath("//button[@type='submit']"));
	...
	public void password1() throws IOException, InterruptedException
	{
		...
		Firstclass.driver.manage().timeouts().implicitlyWait(100, TimeUnit.SECONDS);
		WebDriverWait wait2 = new WebDriverWait(driver, 100);
		Thread.sleep(30000);
		wait2.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@type='text'])[2]"))).click();
		Firstclass.driver.findElement(By.xpath("(//input[@type='text'])[2]")).sendKeys("YVR");
	}
	...
	public void tofield() throws IOException
	{
		...
		Firstclass.driver.findElement(By.xpath("(//input[@type='text'])[3]")).sendKeys("YYZ");
	}

   @AfterSuite
	public void close() throws InterruptedException
	{   
		Firstclass.driver.close();
